# -*- coding: utf-8 -*-
#
# zenpacklib documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  5 14:55:12 2015.
#
...
# Include TODOs in output? Should be False for normal publishing.
...
html_theme = 'sphinx_zenoss_theme'
...
# of the sidebar.
html_logo = "_static/zenoss-logo-213x53-01.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'zenoss.ico'
...
htmlhelp_basename = 'zenpacklibdoc'
