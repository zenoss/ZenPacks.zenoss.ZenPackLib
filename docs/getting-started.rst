...
.. code-block:: bash
    ...
    cd /tmp
    wget http://wiki.zenoss.org/download/zenpacks/ZenPacks.zenoss.ZenPackLib/2.0.7/ZenPacks.zenoss.ZenPackLib-2.0.7.egg
    serviced service run zope zenpack-manager install ZenPacks.zenoss.ZenPackLib-2.0.7.egg
